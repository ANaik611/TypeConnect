            ...
            <div class="row">
                ...
                <div id="content" >
                    ...
                    <form role="form">
                        ...
                        <div class="form-group">
                            <label for="date" class="iconic mail-alt"> DATE OF BIRTH <span class="required">*</span></label> 
                            <input type="date" class="form-control" name="date" id="usermail" placeholder="I promise I hate spam as much as you do" required="required">
                        </div>
                        <div class="form-group">
                            <label for="subject" class="iconic quote-alt"> ADDRESS </label>
                        ...
                        <div class="form-group">
                            <label for="message" class="iconic comment">ENTER GENDER </label>
