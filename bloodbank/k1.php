...
if($_SERVER['REQUEST_METHOD'] == "POST")
{
   $p= $_SESSION['k'];
   echo "$p";
    $q="select * from recipient where rid='$p'";
...
$gender=$_POST['G'];
    ...
    $query="update recipient SET Name='$name',DOB='$dob',Gender='$gender',Phone=$phone,Email='$email',BT='$bloodtype',UNITS=$un where rid='$p'";
...
<label>.   UNITS OF BLOOD:</label><br><input type="num" name="u"><br>
